...
class Utils:
    ...
    def download_button(object_to_download, download_filename, button_text):
        ...
        # Fix here: Use raw string or escape backslash in regex pattern
        button_id = re.sub(r"\d+", "", button_uuid)  # Option 1: Using raw string
        
        # Or this would be a valid alternative:
        # button_id = re.sub("\\d+", "", button_uuid)  # Option 2: Escaping the backslash
